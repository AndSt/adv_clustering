...
def full_evaluate(labels_true, labels_pred):

    acc = cluster_accuracy(true_row_labels=labels_true, predicted_row_labels=labels_pred)
    ...
    return {"acc": acc, "nmi": nmi, "ami": ami, "ari": ari}
